#|
Define built-in operations and associated wrappers here. Expand from what exists in type-resolver.scm
  Re-defines the interface for providing built-in operations' resultant types as a register! system
|#
